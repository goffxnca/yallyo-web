    ...
    <div className="relative ">
      ...
      <div
        className={joinClasses(
          joiners <= 2
            ? "flex flex-col md:flex-row md:flex-wrap md:content-center items-center justify-center h-screen pt-16"
            : joiners <= 4
            ? "flex flex-row flex-wrap content-center items-center justify-center h-screen pt-16"
            : "flex flex-row flex-wrap content-center items-center justify-center h-screen pt-16",
          "bg-pramary"
        )}
      >
